...
const all_topics = [{
    ...
    "topic_id": "cfm",
    "topic_name": "Confidence Intervals",
    "url": "/cfm"
}, {
    "topic_id": "htt",
    ...
    "topic_id": "rge",
    "topic_name": "Regression Analysis",
    "url": "/rge"
}, {
    "topic_id": "anm",
    "topic_name": "ANOVA",
    ...
    return (
        <>
            <div className='flex flex-col mt-6'>
                <i aria-flowto='left'>MathsExplorer &gt; Statistics & Probability</i>
                <h1 className='text-2xl font-semibold mb-4'>Statistics & Probability</h1>
